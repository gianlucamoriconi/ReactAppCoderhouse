                ...
                <div id="values-1" className="options-propery-1 mb-3">
                    ...
                    <div className="d-flex flex-wrap">
                        ...
                        {value1.map((value) => {   
                            ...
                            return <OptionVariant key={valueId} valueId={valueId} valueText={valueText} />    
                        })}
                        </select> */}
                        <Select options={value1} onSelect={setOption1}/>
                    </div>
                </div>
            </div>
            </>
            ...
            <div className="variants mb-5">
                ...
                <div id="values-2" className="options-propery-1 mb-3">
                    ...
                    <div className="d-flex flex-wrap">
                        ...
                        <Select options={value2} onSelect={setOption2}/>
                    </div>
                </div>
            </div>
            </>
